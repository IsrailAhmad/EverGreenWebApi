    ...
    public class StoreRepository : IStoreRepository
    {
            ...
            using (evergreen_androidEntities context = new evergreen_androidEntities())
            {
                var stores = (from s in context.storemasters
                              ...
                              select new StoreModel()
                              {
                                  ...
                                  StoreStatus = s.StoreStatus == "Y" ? true : false,
                                  //StorePicturesUrl = "http://103.233.79.234/Data/EverGreen_Android/StorePictures/" + s.StoreId + ".jpg",
                                  //StorePicturesUrl = "http://103.233.79.234/Data/EverGreen_Android/StorePictures/" + s.StoreId + ".jpg?" + DateTime.Now.ToString(),
                              }).ToList();
                data = stores;
            }
            return data;
        ...
        public StoreModel StoreOpen(int id)
        {
            ...
            using (evergreen_androidEntities context = new evergreen_androidEntities())
            {
                ...
                {
                    if (item.StoreStatus == "Y")
                    {
                        item.StoreStatus = "N";
                    }
                    else if (item.StoreStatus == "N")
                    {
                        item.StoreStatus = "Y";
                    }
