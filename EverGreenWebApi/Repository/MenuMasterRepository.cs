...
namespace EverGreenWebApi.Repository
{
    public class MenuMasterRepository : IMenuMasterRepository
    {
                ...
                if (StoreId == 0)
                {
                    data = (from m in context.menumasters
                            ...
                            select new MenuMasterModel()
                            {
                                ...
                                ImageUrl = "http://localhost/Data/EverGreen_Android/MenuPictures/" + m.MenuId + ".jpg?" + DateTime.Now.ToString(),
                            }).ToList();
                }
                else
                {
        ...
        {
            //string path = "http://103.233.79.234/Data/EverGreen_Android/MenuPictures/";
            ...
            using (evergreen_androidEntities context = new evergreen_androidEntities())
            {
                var data = (from m in context.menumasters
                            ...
                            select new MenuMasterModel()
                            {
                                ...
                                MenuName = m.MenuName,
                                //ImageUrl = "http://103.233.79.234/Data/EverGreen_Android/MenuPictures/" + m.MenuId + ".jpg",
                                //ImageUrl = "http://localhost/Data/EverGreen_Android/MenuPictures/" + m.MenuId + ".jpg",
                            }).ToList();
                datalist = data;
            }
            return datalist;
