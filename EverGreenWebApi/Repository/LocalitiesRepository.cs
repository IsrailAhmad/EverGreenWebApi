        ...
        public IEnumerable<LocalitiesModel> GetAllLocalities(int PageSize, int PageNumber)
        {
            using (evergreen_androidEntities context = new evergreen_androidEntities())
            {
                ...
                var data = result.Select(l => new LocalitiesModel()
                {
                    ...
                    ImageUrl = "http://103.233.79.234/Data/EverGreen_Android/LocalityPictures/" + l.LocalityId + ".jpg",
                }).ToList();
            ...
            using (evergreen_androidEntities context = new evergreen_androidEntities())
            {
                var data = (from lo in context.localitymasters
                            ...
                            select new LocalitiesModel()
                            {
                                ...
                                ImageUrl = "http://103.233.79.234/Data/EverGreen_Android/LocalityPictures/" + lo.LocalityId + ".jpg",
                            }).ToList();
